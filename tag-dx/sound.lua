...
function music()
	...
	if np.currLevelNum == LEVEL_ARENA_RAINBOW or np.currLevelNum == LEVEL_ARENA_CITY or np.currLevelNum == LEVEL_ARENA_SPACE then
		stop_cap_music()
	end
end
...
function handleMusic()
	...
	if (curMap ~= gNetworkPlayers[0].currLevelNum) then
