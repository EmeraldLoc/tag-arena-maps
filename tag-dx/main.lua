...
LEVEL_ARENA_SPACE = level_register('level_arena_space_entry', COURSE_NONE, 'Space', 'space', 28000, 0x28, 0x28, 0x28)
...
gLevelValues.fixCollisionBugs = 1
    ...
    _G.tag.add_level(LEVEL_ARENA_CITY, "City", get_texture_info("painting_city"), 1, nil, nil)
    _G.tag.add_level(LEVEL_ARENA_SPACE, "Space", get_texture_info("painting_space"), 1, nil, nil)
end
